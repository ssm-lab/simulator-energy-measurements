...
from .. import MPI
from ..MPI import ANY_SOURCE, ANY_TAG, PROC_NULL
from ..MPI import Pickle as _Pickle
from ..MPI import Status, _comm_lock, _commctx_inter, _typedict
from ..MPI import memory as _memory

if _sys.version_info >= (3, 8):
    from pickle import HIGHEST_PROTOCOL as _PROTOCOL
    from pickle import dumps as _dumps
    from pickle import loads as _loads
else:  # pragma: no cover
    try:
        from pickle5 import HIGHEST_PROTOCOL as _PROTOCOL
        from pickle5 import dumps as _dumps
        from pickle5 import loads as _loads
    except ImportError:
